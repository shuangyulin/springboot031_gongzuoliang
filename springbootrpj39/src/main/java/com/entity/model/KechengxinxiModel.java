...
public class KechengxinxiModel  implements Serializable {
	...
	public void setJiaoxuedidian(String jiaoxuedidian) {
		this.jiaoxuedidian = jiaoxuedidian;
	}
	
	/**
	 * 获取：教学地点
	 */
	public String getJiaoxuedidian() {
		return jiaoxuedidian;
	}
